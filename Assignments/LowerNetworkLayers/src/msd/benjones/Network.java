...
public class Network {
    ...
    private static HashMap<msd.benjones.Router, HashSet<Neighbor>> links = new HashMap<>();

    private static int messageCount = 0;

    private static void addLink(msd.benjones.Router a, msd.benjones.Router b, int cost){
    ...
    public static void startup() throws InterruptedException {
        for(msd.benjones.Router r : getRouters()){
            r.onInit();
        }
    }

    public static HashSet<Neighbor> getNeighbors(msd.benjones.Router r){
        return links.get(r);
    }

    public static Set<msd.benjones.Router> getRouters(){
        return links.keySet();
    }
    ...
    public static void dump(){
        for(msd.benjones.Router r : links.keySet()){
    ...
    public static void makeSimpleNetwork(){
        reset();
        msd.benjones.Router a = new msd.benjones.Router("a");
        msd.benjones.Router b = new msd.benjones.Router("b");
        msd.benjones.Router c = new msd.benjones.Router("c");
    ...
    public static void makeProbablisticNetwork(int size){
        reset();
        ArrayList<msd.benjones.Router> routers = new ArrayList<>(size);
        ...
        for(int i = 0; i < size; ++i){
            routers.add(new msd.benjones.Router(Integer.toString(i)));
